...
![サービスアカウント確認](screenshot/GCP_ServiceAcount.png)
...
![BigQuery IAM設定](screenshot/BigQuery_IAM.png)
...
![GA4 IAM設定](screenshot/GA4_IAM.png)
...
📄 **ファイル:** [gemini-prompt.md](gemini-prompt.md)
...
📄 **ファイル:** [gemini-prompt-ga4-mcp.md](gemini-prompt-ga4-mcp.md)
...
📄 **ファイル:** [gemini-prompt-ga4-mcp-fix-b.md](gemini-prompt-ga4-mcp-fix-b.md)
...
📄 **ファイル:** [gemini-prompt-ui-fix.md](gemini-prompt-ui-fix.md)
...
📄 **ファイル:** [gemini-prompt-ga4-params-fix.md](gemini-prompt-ga4-params-fix.md)
...
📄 **ファイル:** [gemini-prompt-ga4-routing-fix.md](gemini-prompt-ga4-routing-fix.md)
...
│   ├── genkit.ts              # Genkit初期化
│   ├── agent.ts               # エージェントフロー
│   ├── mcp.ts                 # MCP Host設定 (GA4)
│   ├── mcp-schema-fix.ts      # MCPスキーマパッチ
│   ├── dev.ts                 # Genkit dev用
│   └── tools/
...
└── test-ga4-direct.ts         # GA4 MCP直接テスト
docs/
├── setup1.md                  # この手順書
